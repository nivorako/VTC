...
import { createMockStripe, createMockPaymentIntent, createMockCustomer } from './utils/mockStripe.js';
...
describe('Mock Examples - Stripe', () => {
  ...
  describe('Payment Intents', () => {
    ...
    it('should retrieve a payment intent', async () => {
      const paymentIntent = await mockStripe.paymentIntents.retrieve('pi_mock_123');
...
describe('Mock Examples - Mongoose', () => {
  ...
  describe('Model Operations', () => {
    ...
    it('should update a document', async () => {
      const result = await MockUserModel.updateOne({ email: 'new@example.com' });
