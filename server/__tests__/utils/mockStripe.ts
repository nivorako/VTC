...
export const createMockStripe = () => {
  const mockPaymentIntents = {
    create: jest.fn((..._args: unknown[]) => Promise.resolve({
    ...
    retrieve: jest.fn((..._args: unknown[]) => Promise.resolve({
      id: 'pi_mock_123456789',
      status: 'succeeded',
      amount: 5000,
      currency: 'eur',
    ...
    cancel: jest.fn((..._args: unknown[]) => Promise.resolve({
      id: 'pi_mock_123456789',
      status: 'canceled',
      amount: 5000,
      currency: 'eur',
...
export const createMockPaymentIntent = (overrides?: Partial<MockPaymentIntent>): MockPaymentIntent => ({
  id: 'pi_mock_123456789',
  client_secret: 'pi_mock_secret_123456789',
  amount: 5000,
  currency: 'eur',
